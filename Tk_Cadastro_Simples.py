...
fr1 = Frame(root, padx=10, pady=10)
fr2 = Frame(root, padx=10, pady=10)
fr3 = Frame(root, padx=10, pady=10)
...
lb2_fr2 = Label(fr2, text='Rua:', font='Verdana 12', anchor=E, pady=3)
lb3_fr2 = Label(fr2, text='N°:', font='Verdana 12', anchor=E, pady=3)
lb4_fr2 = Label(fr2, text='Bairro:', font='Verdana 12', anchor=E, pady=3)
lb5_fr2 = Label(fr2, text='Cidade:', font='Verdana 12',  anchor=E, pady=3)
lb6_fr2 = Label(fr2, text='UF:', font='Verdana 12',  anchor=E, pady=3)
...
# ########################## widgets frame 3 ########################## #
bt1_fr3 = Button(fr3, text='Gravar Dados')
bt2_fr3 = Button(fr3, text='Listar Dados')
...
bt1_fr3.grid(row=0, column=0, sticky=EW)
bt2_fr3.grid(row=0, column=1, sticky=EW)
